 ...
 */
__webpack_require__(/*! ./axios/createTagCategory */ "./resources/js/axios/createTagCategory.js");
...
/***/ "./resources/js/axios/createTagCategory.js":
/*!*************************************************!*\
  !*** ./resources/js/axios/createTagCategory.js ***!
  \*************************************************/
...
$('.addCategory').on('click', function () {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/admin/categoryPost', data, config).then(function (response) {
    if (response.data.status === false && response.data.errors) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/categoryPost').then(function (categories) {
        var categoriesList;
        categories.data.forEach(function (item) {
          categoriesList += "  <div class=\"form-check\">\n                                <input class=\"form-check-input\" type=\"checkbox\" id=\"".concat(item.slug, "\" name=\"categories[]\" value=\"").concat(item.id, "\">\n                                       <label class=\"form-check-label\" for=\"").concat(item.slug, "\">").concat(item.name, "</label>\n                            </div>");
        });
...
$('.addTag').on('click', function () {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/admin/tag', data, config).then(function (response) {
    if (response.data.status === false && response.data.errors) {
      $('.susses-tag').fadeOut();
      $('.errors-tag').fadeIn();
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/tag').then(function (tags) {
        var tagsList;
        tags.data.forEach(function (item) {
...
/***/ "./resources/js/axios/fastCheck.js":
/*!*****************************************!*\
  !*** ./resources/js/axios/fastCheck.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
$('.quickview').on('click', function (e) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get(url).then(function (responce) {
